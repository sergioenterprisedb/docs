...
| ---------------------------- | --------------------------------------------------- |
| PostgreSQL                   | 12–16                                               |
| EDB Postgres Advanced Server | 12–15, 14-15 for distributed high-availability clusters |
...
| The PostgreSQL community plans to deprecate PostgreSQL  and won't provide any security patches after this date.                                                                                                                                                                                                                                  | November 9, 2023    |
